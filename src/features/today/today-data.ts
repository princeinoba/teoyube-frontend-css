...
export const TODAY_PREVIEW_SLIDES: readonly TodayPreviewSlide[] = Object.freeze([
  { title: "Divine Direction", theme: "God guides every faithful step.", image: "public/images/ads/divine-direction.png", position: "center" },
  { title: "Strength for Today", theme: "Renewed strength for today's journey.", image: "public/images/ads/strength-for-today.png", position: "center" },
  { title: "Growth in Grace", theme: "Grow deeper in Christ every day.", image: "public/images/ads/growth-in-grace.png", position: "center" },
  { title: "Blending the Human Experience with the Digital Frontier", theme: "Connecting tomorrow.", image: "public/images/teoyube-carousel-5-wide.png", position: "72% center" },
...
export const TODAY_ASSIGNMENT_ITEMS = Object.freeze([
...
export const TODAY_SEARCH_SUGGESTIONS = Object.freeze([
  "Romans 8:28-30",
  "TeoyubeWorld",
  "Scripture teaching",
  "prayer video",
