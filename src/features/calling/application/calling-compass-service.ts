...
const MEDIA: readonly CallingMediaDto[] = Object.freeze([
  Object.freeze({ id: "local-seed-of-promise", title: "The Seed of Promise", description: "A local TeoyubeWorld preview about tending promise language through Scripture and faithful action.", duration: "24:35", image: "public/images/embed/embedded-videos-hero-bg.png" }),
  Object.freeze({ id: "local-power-of-prayer", title: "The Power of Prayer", description: "A Scripture-rooted local preview for prayer, surrender, wisdom, and one faithful next step.", duration: "30:12", image: "public/images/today/teoyubeworld-search-bg.png" }),
  Object.freeze({ id: "local-walk-in-purpose", title: "Walk in Divine Purpose", description: "A cautious calling preview connected to Scripture, courage, fruit, counsel, and time.", duration: "21:47", image: "public/images/table/calling-compass-panel-bg.png" }),
  Object.freeze({ id: "local-rooted-in-word", title: "Rooted in His Word", description: "A local preview about Scripture remaining the highest authority.", duration: "28:16", image: "public/images/search/search-purpose-hero.png" }),
  Object.freeze({ id: "local-called-for-more", title: "Called for More", description: "A short local preview for prayerfully testing emerging calling patterns.", duration: "26:08", image: "public/images/canon/journey-calling.png" }),
  Object.freeze({ id: "local-strength-for-today", title: "Strength for Today", description: "A local preview for patient trust and one faithful next step.", duration: "19:45", image: "public/images/carousel/kingdom-wisdom.png" }),
