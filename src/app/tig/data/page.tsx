import { TIGDataManagerPanel } from "src/components/tig/TIGDataManagerPanel";

export default function TIGDataPage() {
  return (
      ...
      <div className="mx-auto max-w-6xl space-y-8">
        <section className="rounded-3xl border border-emerald-100 bg-white/80 p-6 shadow-sm shadow-emerald-950/5 sm:p-8">
          ...
          <h1 className="mt-3 text-3xl font-semibold tracking-tight text-slate-950 sm:text-4xl">
            Teoyube Data Manager
          </h1>
          <p className="mt-3 max-w-4xl text-base leading-7 text-slate-600">
            Export, import, and review session-only journey activity and journal entries.
          </p>
          <p className="mt-4 rounded-xl border border-emerald-100 bg-emerald-50 px-4 py-3 text-sm text-emerald-900">
            This version uses session memory only. Firestore sync and browser persistence are not
            connected.
          </p>
        </section>
