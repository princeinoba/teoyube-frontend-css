import { TIGJournalPanel } from "src/components/tig/TIGJournalPanel";

export default function TIGJournalPage() {
  return (
      ...
      <div className="mx-auto max-w-6xl space-y-8">
        <section className="rounded-3xl border border-emerald-100 bg-white/80 p-6 shadow-sm shadow-emerald-950/5 sm:p-8">
          ...
          <p className="mt-3 max-w-4xl text-base leading-7 text-slate-600">
            Saved reflections from Scripture prompts, prayers, promises, and growth journeys.
          </p>
