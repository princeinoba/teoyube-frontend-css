...
export const DATA_CLASSIFICATION_REGISTRY: Readonly<Record<DataClassId, DataClassPolicy>> = Object.freeze({
  ...
  class_2: Object.freeze({
    ...
    allowedPurposes: Object.freeze(["journey_continuity", "testimony_book_continuity"]), defaultPersistence: "explicit_only", requiredConsent: "journey_continuity", storageLocation: "server_relational", encryption: "standard_at_rest", logPolicy: "identifiers_only", retention: "until revoked, deleted, account deletion, or 24 months of inactivity", exportPolicy: "included with provenance", deletionPolicy: "delete active and derived records", sharingPolicy: "none", modelUsePolicy: "disabled", analyticsPolicy: "aggregate_non_content_only"
  }),
