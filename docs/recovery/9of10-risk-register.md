...
| 9R-05 | Real-user evidence absent | Phase 4A and 4B PASS; Phase 4C operations and synthetic drill PASS; recruitment WAITING_OWNER; mode disabled; 0 participants, sessions, or actual participant records | Phase 4 | Owner authorizes recruitment, qualified operators conduct consent-bound sessions, and Phase 4D obtains owner-accepted analysis |
...
| 9R-15 | Recruitment begins without the required Phase 4C owner decision | Operational materials are ready, but recruitment/operator/contact-storage/privacy-review fields remain `PENDING`; no real records exist | Phase 4C | Owner explicitly chooses authorize, authorize with safe changes, or hold; no automatic recruitment follows |
